...
if(typeof define==='function'&&typeof define.amd==='object'&&define.amd){define(function(){return ScrollReveal})}else if(typeof module!=='undefined'&&module.exports){module.exports=ScrollReveal}else{window.ScrollReveal=ScrollReveal}})();$(document).ready(function(){window.sr=ScrollReveal();sr.reveal('.tile',{duration:1200,reset:true});});